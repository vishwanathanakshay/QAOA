...
f_name1 = f'data_2_sat_{n}N_{m}M_{depth}P_performance.csv'
f_name2 = f'data_2_sat_{n}N_{m}M_{depth}P_performance_angles.csv'

run_performance(n, m, workers, depth)
